...
export class ProfileComponent implements OnInit, OnDestroy {
  ...
  openBottomSheet(): void {
    ...
    this._bottomSheet.open(BottomSheetOverviewExampleSheet, { data: { mydata: this.profile, NewUid: this.profileinfoUid } });
  }
...
export class BottomSheetOverviewExampleSheet {
  ...
  save()
  {
    if(this.data.NewUid !== null && this.data.NewUid !== undefined) {
